...
// Super Admin Auth Routes (Separate Login)
Route::middleware('web')->group(function () {
    // Guest routes for superadmin
    ...
    // Authenticated superadmin logout
    Route::middleware(['auth:admin', 'admin', 'superadmin'])->group(function () {
...
Route::middleware(['web', 'auth:admin', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['superadmin'])->prefix('superadmin')->name('superadmin.')->group(function () {
        ...
        Route::delete('/admins/{user}', [SuperAdminController::class, 'destroyAdmin'])->name('destroy-admin');

        // Toggle Admin Status
        Route::patch('/admins/{user}/toggle-admin', [SuperAdminController::class, 'toggleAdminStatus'])->name('toggle-admin');
        Route::patch('/admins/{user}/toggle-superadmin', [SuperAdminController::class, 'toggleSuperAdminStatus'])->name('toggle-superadmin');

        // Account Deletion Requests Management
        Route::get('/deletion-requests', [SuperAdminController::class, 'deletionRequests'])->name('deletion-requests');
        Route::post('/deletion-requests/{request}/approve', [SuperAdminController::class, 'approveDeletionRequest'])->name('deletion-requests.approve');
        Route::post('/deletion-requests/{deletionRequest}/reject', [SuperAdminController::class, 'rejectDeletionRequest'])->name('deletion-requests.reject');
    });
});