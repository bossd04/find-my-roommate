   ...
   public function store(Request $request)
{
    ...
    // Set default values
    // Map property_type to valid enum values ('roommate', 'room', 'apartment')
    $propertyTypeMap = [
        'apartment' => 'apartment',
        'house' => 'apartment',
        'condo' => 'apartment',
    ...
    $validated['type'] = $propertyTypeMap[$validated['property_type']] ?? 'apartment';
    ...
    // Set the landlord_id and user_id to the currently authenticated admin's ID
    $validated['landlord_id'] = auth('admin')->id();
    $validated['user_id'] = auth('admin')->id();

    // Map price to min_price and max_price for database compatibility
    if (isset($validated['price'])) {
        $validated['min_price'] = $validated['price'];
        $validated['max_price'] = $validated['price'];
    }
