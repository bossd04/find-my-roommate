    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form method="POST" action="{{ route('profiles.update', $profile) }}" class="mt-8 space-y-8 divide-y divide-gray-200" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-8 divide-y divide-gray-200">
                        ...
                        <div class="pt-8">
                            ...
                            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <textarea id="bio" name="bio" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-md @error('bio') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror">{{ old('bio', $profile->bio) }}</textarea>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" name="university" id="university" value="{{ old('university', $profile->university) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" name="major" id="major" value="{{ old('major', $profile->major) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <select id="noise_level" name="noise_level" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('noise_level') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror">
                                            ...
                                            <option value="very_quiet" {{ old('noise_level', $profile->noise_level) == 'very_quiet' ? 'selected' : '' }}>Very Quiet</option>
                                            <option value="quiet" {{ old('noise_level', $profile->noise_level) == 'quiet' ? 'selected' : '' }}>Quiet</option>
                                            <option value="moderate" {{ old('noise_level', $profile->noise_level) == 'moderate' ? 'selected' : '' }}>Moderate</option>
                                            <option value="lively" {{ old('noise_level', $profile->noise_level) == 'lively' ? 'selected' : '' }}>Lively</option>
                                            <option value="very_loud" {{ old('noise_level', $profile->noise_level) == 'very_loud' ? 'selected' : '' }}>Very Loud</option>
                                        </select>
                                        @error('noise_level')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-1">
                                        <select id="schedule" name="schedule" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('schedule') border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror">
                                            ...
                                            <option value="irregular" {{ old('schedule', $profile->schedule) == 'irregular' ? 'selected' : '' }}>Irregular Schedule</option>
                                        </select>
                                        @error('schedule')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="mt-2 space-y-2">
                                            <div class="flex items-center">
                                                <input id="smoking_allowed" name="smoking_allowed" type="checkbox" value="1" {{ old('smoking_allowed', $profile->smoking_allowed) ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                                <label for="smoking_allowed" class="ml-2 block text-sm text-gray-700">Smoking allowed</label>
                                            </div>
                                            <div class="flex items-center">
                                                <input id="pets_allowed" name="pets_allowed" type="checkbox" value="1" {{ old('pets_allowed', $profile->pets_allowed) ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                        ...
                        <div class="pt-8">
                            ...
                            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                <div class="sm:col-span-6">
                                    <div class="flex items-start">
                                        <div class="flex items-center h-5">
                                            <input id="has_apartment" name="has_apartment" type="checkbox" value="1" {{ old('has_apartment', $profile->has_apartment) ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                        </div>
                                ...
                                <div id="apartment-fields" class="sm:col-span-6 pl-6 border-l-2 border-gray-200 {{ old('has_apartment', $profile->has_apartment) ? '' : 'hidden' }}">
                                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                        <div class="sm:col-span-6">
                                            <label for="apartment_location" class="block text-sm font-medium text-gray-700">Apartment Location</label>
                                            <div class="mt-1">
                                                <input type="text" name="apartment_location" id="apartment_location" value="{{ old('apartment_location', $profile->apartment_location) }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-1 relative rounded-md shadow-sm">
                                                ...
                                                <input type="number" name="budget_min" id="budget_min" min="0" step="50" value="{{ old('budget_min', $profile->budget_min) }}" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md">
                                            </div>
                                        </div>
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-1 relative rounded-md shadow-sm">
                                                ...
                                                <input type="number" name="budget_max" id="budget_max" min="0" step="50" value="{{ old('budget_max', $profile->budget_max) }}" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md">
                                            </div>
                                        </div>
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-1">
                                                <input type="date" name="move_in_date" id="move_in_date" value="{{ old('move_in_date', $profile->move_in_date ? $profile->move_in_date->format('Y-m-d') : '') }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                            </div>
                                        </div>
                                        ...
                                        <div class="sm:col-span-3">
                                            ...
                                            <div class="mt-1">
                                                <select id="lease_duration" name="lease_duration" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                                    <option value="" {{ old('lease_duration', $profile->lease_duration) ? '' : 'selected' }}>Select duration</option>
                                                    <option value="1 month" {{ old('lease_duration', $profile->lease_duration) == '1 month' ? 'selected' : '' }}>1 Month</option>
                                                    <option value="3 months" {{ old('lease_duration', $profile->lease_duration) == '3 months' ? 'selected' : '' }}>3 Months</option>
                                                    <option value="6 months" {{ old('lease_duration', $profile->lease_duration) == '6 months' ? 'selected' : '' }}>6 Months</option>
                                                    <option value="1 year" {{ old('lease_duration', $profile->lease_duration) == '1 year' ? 'selected' : '' }}>1 Year</option>
                                                    <option value="Flexible" {{ old('lease_duration', $profile->lease_duration) == 'Flexible' ? 'selected' : '' }}>Flexible</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="pt-5">
                        <div class="flex justify-between">
                            <button type="button" onclick="if(confirm('Are you sure you want to delete your profile? This action cannot be undone.')) { document.getElementById('delete-form').submit(); }" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-red-700 bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                Delete Profile
                            </button>
                            <div>
